...
//        JwtAuthenticationFilter jwtFilter = new JwtAuthenticationFilter(jwtUtil, refreshTokenRepository, userRepository);
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("https://sdui-delta.vercel.app","http://sdui-delta.vercel.app", "http://localhost:3000", "http://localhost:8080","http://43.201.237.68","http://43.201.237.68:8081","https://justsaying.co.kr", "http://justsaying.co.kr"));
