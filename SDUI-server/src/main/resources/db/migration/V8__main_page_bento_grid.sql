...
-- 삭제 대상: MAIN_TOP_CARD, MAIN_LOGIN_CARD, MAIN_TUTORIAL_CARD + 자식 전체
...
-- Card 1: 약속 위젯 (col 1-2) — TIME_RECORD_WIDGET → RecordTimeComponent
...
-- Card 1: 시간 설정하기 (col 1-2) — TIME_RECORD_WIDGET (no-goal 상태 렌더링)
INSERT INTO ui_metadata
  (screen_id, component_id, component_type, parent_group_id, css_class, allowed_roles, sort_order)
VALUES
